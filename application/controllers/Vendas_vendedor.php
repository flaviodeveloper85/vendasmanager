...
class vendas_vendedor extends CI_Controller {
	...
	public function index()
	{
		...
		$data['prod_disponivel'] = $this->vendas_vendedor_model->getProdutosDisponivel();
		$data['vendas'] = $this->vendas_vendedor_model->getSell($id_user);

		$this->load->view('vendas_vendedor', $data);
	}
	...
	public function updateStatusVenda()
	{
		...
		$update = $this->vendas_vendedor_model->updateStatusVenda($id_venda, $novo_status, $id_produto);
		if(!$update)
		{
			echo "Error!";
