						...
						<div class="row">
							<div class="col-lg-3 menu" style="padding:40px">
							    ...
							    <?php endforeach;?>
								    ...
								    <p style="font-size:12px">Troque de status (vendido ou cancelado). Para informaçoes detalhadas, procure um administrador e informe o código da venda.</p>
						    <?php } ?><!-- final condiçao end -->
							</div>
							<div class="col-lg-8 menu">
							
								<div style="position:relative;left:115px;padding:30px;height:400px; margin-top:250px;color:gray">
									<!--vendas-->
									
									<a href="<?php echo site_url()?>vendas_vendedor">
									<div class="box-item">
									...
									<div class="box-item">
										<i class="fa fa-database" aria-hidden="true" style="font-size:38px"></i><br />
										<span style="font-weight:bold">ESTOQUE</span>
									</div>
									</a>

									<a href="<?php echo site_url()?>conta_vendedor">
									<div class="box-item">
